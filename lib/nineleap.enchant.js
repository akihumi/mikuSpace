...
enchant.nineleap = { assets: ['./img/start.png', './img/end.png','./img/clear.png'] };
...
enchant.nineleap.Game = enchant.Class.create(enchant.Game, {
    ...
    initialize: function(width, height) {
	    ...
	    this.clearScene = new ClearScene();
            this.clearScene.image = this.assets['./img/clear.png'];
            this.scoreQueue = false;
            gameStart = false; // deprecated
            this.started = false;
        });
...
enchant.nineleap.ClearScene = enchant.Class.create(enchant.Scene, {
    image: {
        get: function() {
            return this._image;
        },
